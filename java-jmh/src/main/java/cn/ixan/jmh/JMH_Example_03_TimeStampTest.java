...
import cn.ixan.jmh.utils.TimeUtil_Cobar;
...
public class JMH_Example_03_TimeStampTest {
	private static final int MAX = 10_000_000;

	public static void main(String[] args) throws RunnerException {
		Options opt = new OptionsBuilder()
				.include(JMH_Example_03_TimeStampTest.class.getSimpleName())
				.forks(1)
				.warmupIterations(1)
	...
	public void test1Thread() {
		for (int i = 0; i < MAX; i++) {
			TimeUtil_Cobar.currentTimeMillis();
		}
	}
